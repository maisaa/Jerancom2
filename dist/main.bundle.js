...
var ClothesComponent = (function () {
    ...
    ClothesComponent.prototype.rent = function (i, seeitem) {
        var _this = this;
        console.log(i);
        var that = this;
        console.log(that);
        this.http.post('https://jerancoma.herokuapp.com/renter', {
            ...
            alert('ok');
            console.log(data);
            _this.result.splice(_this.result.indexOf(seeitem));
        }, function (error) {
            console.log(error, "erooooooooooooooooooe");
        });
    };
